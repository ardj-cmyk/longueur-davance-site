  ...
  <div class="wrap rv">
    ...
    <ol class="tl">
      ...
      <li><h3>La proposition</h3>
        <p>Si ça vaut le coup, on vous dit ce qu'on installe et pour combien.
           Si ça ne vaut pas le coup, on vous le dit aussi.</p></li>
      <li><h3>Les séances d'installation (45 min chacune)</h3>
        <p>Une séance, ou plusieurs selon ce que vous voulez traiter. Tout est préparé
           en amont. On installe sur votre poste, vous voyez chaque étape, et à la fin
