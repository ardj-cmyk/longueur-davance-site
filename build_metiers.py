...
<section style="background:var(--surface)">
  <div class="wrap rv">
    <div class="kicker">Les 45 minutes</div>
    <h2 style="font-size:clamp(26px,5.5vw,40px);max-width:16ch">Comment ça se passe.</h2>
    <ol class="tl">
      <li><h3>On identifie la tâche (10 min)</h3>
        <p>Vous racontez votre semaine. On cherche celle qui revient le plus souvent
           et qui vous coûte le plus de temps pour le moins de valeur.</p></li>
      <li><h3>On la monte en direct (25 min)</h3>
        <p>Partage d'écran, avec vos vrais exemples. À la fin, ça tourne sur votre cas,
           pas sur une démo.</p></li>
      <li><h3>Vous repartez avec (10 min)</h3>
        <p>On refait le tour pour que vous sachiez le relancer seul, et vous recevez
           la marche à suivre écrite.</p></li>
    </ol>
  </div>
</section>
...
<section style="background:var(--surface)">
  <div class="wrap rv" style="max-width:760px">
    ...
    <details><summary class="faq-q">Combien ça coûte ?</summary>
      <p>La séance est à 490 € pour mes 10 premiers clients, puis 790 €. Si vous voulez aller
         plus loin, c'est chiffré après l'audit, sur une grille identique pour tout le monde.
